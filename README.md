# Readability with Korean websites available

This libaray was created for parsing and handling off data to the 3-line libaray

This is based on node-readability and also supports Naver news.
...
## Features
1. Optimized for more news sites including Naver.
...
> Options only work when the web crawling is not Naver
